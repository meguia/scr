...
# MOV 1
#bajo la velocidad
ctrl.make_conf(255,1,tipo='vel')
ctrl.make_conf(255,1,tipo='acl')
ctrl.make_conf(20,2,tipo='vel')
ctrl.make_conf(20,2,tipo='acl')

ctrl.send_conf(2,tipo='vel')
ctrl.send_conf(2,tipo='acl')
#movimiento casi imperceptible
ctrl.send_conf(4)
ctrl.send_conf(9)


ctrl.send_conf(1,tipo='vel')
ctrl.send_conf(1,tipo='acl')
# MOV2
#escalonado
...
ctrl.send_rand_mask(50,30,range(5))

# mueve de a 1 columna por fila al azar
ctrl.send_rand_mask(51,0,nmask = 0)
ctrl.send_rand_mask(1,0,nmask = 0, tipo='rgb')

ctrl.send_rand_mask(51,0,nmask = 1)
ctrl.send_rand_mask(1,0,nmask = 1, tipo='rgb')

ctrl.send_rand_mask(51,0,nmask = 2)
ctrl.send_rand_mask(1,0,nmask = 2, tipo='rgb')

ctrl.send_rand_mask(51,0,nmask = 3)
ctrl.send_rand_mask(1,0,nmask = 3, tipo='rgb')

ctrl.send_rand_mask(51,0,nmask = 4)
ctrl.send_rand_mask(1,0,nmask = 4, tipo='rgb')
